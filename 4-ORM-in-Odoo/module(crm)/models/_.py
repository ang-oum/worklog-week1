...
#ORM to generate a database table named test_model:
...
#__________________________________Exercise________________________________
...
# Simple field examples are Boolean, Integer, Float, Char, Text, Date and Selection.
